        ...
        {!showDefinitionPrompt ? (
          <>
            ...
            <Text style={styles.instruction}>
              {inputMethod === 'VOICE' ? 'Tap mic and spell the word aloud' : 'Listen and type the word'}
            </Text>
            ...
            <View style={styles.buttonColumn}>
              ...
              {/* Correct word appears below mic when incorrect */}
              {feedback && !feedback.isCorrect && feedback.correctWord && (
                <Text style={styles.correctWordBelow}>{feedback.correctWord}</Text>
              )}
            </View>
            ...
            <TextInput
              ...
              placeholder={inputMethod === 'VOICE' ? 'Speak your answer' : 'Type the word here'}
              autoCapitalize="none"
              autoCorrect={false}
            ...
            {/* Feedback */}
            {feedback && (
              <View style={[styles.feedbackIconOnly, feedback.isCorrect ? styles.feedbackCorrect : styles.feedbackIncorrect]}>
                <Text style={styles.feedbackIconLarge}>
                  {feedback.isCorrect ? '✓' : '✗'}
                </Text>
                {!feedback.isCorrect && feedback.correctWord && (
                  <Text style={styles.correctWordText}>{feedback.correctWord}</Text>
                )}
              </View>
            )}
